...
Then when you open the code in visual studio, click run and then run without debugging, 
 the type either odd or strategy-based to choose difficulty (odd means the opponent makes random decisions and strategy-based uses extra factors influencing
